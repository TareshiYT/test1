...
<template>  
    <div class="absolute electrician-global-container"> 
        <div class="electrician-global-container-effect"></div>

        <div class="electrician-gloabl-title">
            <div class="title"><i class="fa-solid fa-bolt"></i> Electrician Job</div>
            <div class="subtitle">Please fix the wires with the correct colors.</div>
        </div>
...
<script>  
    ...
    export default {
        ...
        mounted()
        { 
            window.ElectricianComponent = this;  
            ...
            function toggleLight(selector, visibility) 
            {
                if(visibility)
                {
                    ...
                    if(completedLights[0] === 1 && completedLights[1] === 1 && completedLights[2] === 1 && completedLights[3] === 1) 
                    {
                        ...
                        window.setTimeout(() => {
                            ...
                            if(window.mp)
                            {
                                return window.e_rpc('server::jobs:electrician:complete');
                            }
                ...
                gsap.to(`.light-${selector}`, { opacity: visibility ? 1 : 0, duration: 0.3 });
            }
